function w = fct_w_toy7(model)
% Create a filament of vorticity (pure uniform shear)
%
...
center1=c*[1 1];
R1=R;
vort = fct_filament(model,center1,R1);
...
function phi = fct_filament(model_,center,Radius)
