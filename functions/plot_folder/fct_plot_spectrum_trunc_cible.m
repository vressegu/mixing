function fct_plot_spectrum_trunc_cible(model,f,day,color)
...
%     'linear') == 1 );
% % % mask_keep_cart = fct_sph2cart(lon_global, ...
% % %           lat_global,mask_keep_,X,Y,lonlat_ref);
...
fct_spectrum2( model,fft_w(:,:,:,id_part),color);
