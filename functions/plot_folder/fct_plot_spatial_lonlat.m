function fct_plot_spatial_lonlat(model,T_adv_part,day)
...
%     height = 3.2;
    ...
    ax = [lon(end)-lon(1) lat(end)-lat(1)] ;
...
colorbar
drawnow
eval( ['print -depsc ' folder_simu '/one_realization_lonlat/'...
    num2str(day) '.eps']);       
...
%     'PaperPositionMode','auto');
% fct_spectrum2( model,fft_b_adv_part(:,:,:,id_part),'b');
